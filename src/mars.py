...
class TriAN(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.q_self_attn_start = layers.LinearSeqAttn(question_hidden_size, p_max_size)
        self.p_q_attn_start = layers.BilinearSeqAttn(question_hidden_size, p_max_size)

        self.q_self_attn_end = layers.LinearSeqAttn(question_hidden_size, p_max_size)
        self.p_q_attn_end = layers.BilinearSeqAttn(question_hidden_size, p_max_size)
    ...
    def forward(self, p, p_pos, p_ner, p_mask, q, q_pos, q_mask, f_tensor, p_q_relation):
        ...
        print('single_map_proba_start', single_map_proba_start.size())
